...
public class HiddenDivPopup2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("policynumber")).sendKeys("098765432");
		Thread.sleep(2000);
		driver.findElement(By.id("dob")).click();//calendar popup
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.id("alternative_number")).sendKeys("76144334");
		Thread.sleep(2000);
